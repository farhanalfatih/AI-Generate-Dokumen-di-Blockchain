...
const Layanan = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-8">
      ...
      >
        Kami menyediakan layanan berbasis blockchain dengan dukungan AI untuk
        mengelola dan mengamankan dokumen digital Anda.
      </motion.p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 w-full max-w-6xl">
        ...
        {/* Tengah → Klik navigate ke /upload */}
        <motion.div
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
        ...
        >
          ...
          <p className="text-sm mt-3 text-gray-300 text-center">
            Unggah file Anda untuk diproses dengan AI di blockchain. Aman,
